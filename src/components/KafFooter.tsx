...
export default function KafFooter({ settings }: { settings?: Partial<SiteSetting> | null }) {
  ...
  </div></div><div className="kaf-footer-bottom"><div className="kaf-footer-bottom-inner"><p>Every Order is Packed with Care <span>♥</span> and Delivered with Trust.</p><p>{s.copyrightText || `Copyright © ${new Date().getFullYear()} KAF LifeStyle. All Rights Reserved.`}</p></div></div></footer>;
}
