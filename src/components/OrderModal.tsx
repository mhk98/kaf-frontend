...
export default function OrderModal({ product, onClose, mode = "order" }: OrderModalProps) {
      ...
      <div className="relative w-full max-w-[680px] mx-3 sm:mx-0">
        ...
        >
          <span className="text-white font-semibold text-lg tracking-wide">
            {mode === "cart" ? "Choose options" : "Select variation"}
          </span>
        </div>
          ...
          <div className="flex flex-col sm:flex-row gap-5 sm:gap-7">
            ...
            <div className="flex flex-col gap-4 sm:gap-5 flex-1">
              ...
              <div className="flex items-center gap-4 mt-1">
                ...
                {/* Order Now button */}
                <button
                  onClick={mode === "cart" ? handleAddToCart : handleOrder}
